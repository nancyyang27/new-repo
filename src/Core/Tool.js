...
import jobad from '../tools/jobad';
import CallLambda from '../Lambda/CallLambda'
...
class Tool extends Component {
    ...
    onGenerateClick = async () => {
        try {
            ...
            console.log(this.tool.api);
            console.log(postObj);
            const apiName = 'opanAIMainApi';
            const myInit = {
                body: postObj, // replace this with attributes you need
                headers: {} // OPTIONAL
              };

            let response = await API.post(apiName, this.tool.api, myInit);
